...
def train_one_epoch(model, dataloader, optimizer, criterion, device):
    ...
    for images, fine_labels, coarse_labels in dataloader:
        ...
        # Forward
        mixed_images, y_a, y_b, lam = mixup_data(images, coarse_labels, 0.2)
        ...
        running_acc += accuracy_top1(logits, coarse_labels) * batch_size
...
def evaluate(model, dataloader, criterion, device):
    ...
    with torch.no_grad():
        for images, fine_labels,coarse_labels in dataloader:
            ...
            loss = criterion(logits, coarse_labels)
...
def main():
    ...
    # Model
    model = CoarseGrainedClassifierCNN()
    model.to(device)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if test_acc > best_test_acc:
            ...
            torch.save(model.state_dict(), "D-tasks\models\d2.pth")
...
def prepare_test():
    ...
    weights_path = 'D-tasks\models\d2.pth'
